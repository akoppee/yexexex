...
!function(a, b) {
    ...
    function a(a, b) {
        ...
        return f = b.pressure && c.buttons ? b.pressure : c.buttons ? .5 : 0,
        c.x = c.clientX,
        c.y = c.clientY,
    ...
    function j(a) {
        if (!a.ownerDocument.contains(a)) {
            ...
            throw b.name = "InvalidStateError",
            b
        }
    }
    function k(a) {
   ...
   */
    ...
    b.prototype = {
        set: function(a, b) {
            return void 0 === b ? this["delete"](a) : (this.has(a) || this.size++,
            void (this.array[a] = b))
        },
        has: function(a) {
        ...
        "delete": function(a) {
            this.has(a) && (delete this.array[a],
            this.size--)
        },
        get: function(a) {
            return this.array[a]
     ...
     */
        makeEvent: function(b, c) {
            ...
            var d = new a(b,c);
            return c.preventDefault && (d.preventDefault = c.preventDefault),
     ...
     */
        ...
        propagate: function(a, b, c) {
            for (var d = a.target, e = []; !d.contains(a.relatedTarget) && d !== document; )
                e.push(d),
                d = d.parentNode;
            c && e.reverse(),
        ...
        setCapture: function(b, c) {
            this.captureInfo[b] && this.releaseCapture(b),
            this.captureInfo[b] = c;
            var d = new a("gotpointercapture");
            d.pointerId = b,
            this.implicitRelease = this.releaseCapture.bind(this, b),
    ...
    var v = {
        shadow: function(a) {
            if (a)
                return a.shadowRoot || a.webkitShadowRoot
        },
        ...
        searchRoot: function(a, b, c) {
            if (a) {
                ...
                for (// is element a shadow host?
                e = this.targetingShadow(f); e; ) {
                    if (// find the the element inside the shadow root
        ...
        findTarget: function(a) {
            ...
            return d.elementFromPoint(b, c) || (d = document),
    ...
    c.prototype = {
        ...
        flattenMutationTree: function(a) {
            ...
            return b.push(z(a, this.isElement)),
    ...
    var M, N = {
        ...
        setPrimaryTouch: function(a) {
            ...
            (0 === R.size || 1 === R.size && R.has(1)) && (this.firstTouch = a.identifier,
            this.firstXY = {
                X: a.clientX,
                Y: a.clientY
            },
        ...
        removePrimaryPointer: function(a) {
            a.isPrimary && (this.firstTouch = null,
            this.firstXY = null,
        ...
        typeToButtons: function(a) {
            var b = 0;
            return "touchstart" !== a && "touchmove" !== a || (b = 1),
            b
        },
        touchToPointer: function(a) {
            ...
            c.pressure = a.force || a.webkitForce || .5,
        ...
        processTouches: function(a, b) {
            ...
            for (var d, e = 0; e < c.length; e++)
                d = c[e],
                b.call(this, this.touchToPointer(d))
        },
        ...
        touchstart: function(a) {
            ...
            this.processTouches(a, this.overDown))
        },
        overDown: function(a) {
            R.set(a.pointerId, {
                target: a.target,
        ...
        touchmove: function(a) {
            this.scrolling || (this.shouldScroll(a) ? (this.scrolling = !0,
            this.touchcancel(a)) : (a.preventDefault(),
        ...
        moveOverOut: function(a) {
            ...
            if (c) {
                ...
                d.target = e,
                b.target ? (u.leaveOut(d),
                u.enterOver(b)) : (// clean up case when finger leaves the screen
                b.target = e,
    ...
    var W, X, Y = u.pointermap, Z = window.MSPointerEvent && "number" == typeof window.MSPointerEvent.MSPOINTER_TYPE_MOUSE, $ = {
    ...
    _.msPointerEnabled ? (W = function(a) {
        i(a),
        j(this),
        k(a) && this.msSetPointerCapture(a)
    }
    ,
    X = function(a) {
        i(a),
        ...
        i(a),
        j(this),
        k(a) && u.setCapture(a, this)
    }
    ,
    X = function(a) {
        i(a),
        u.releaseCapture(a, this)
    }
    ),
    g(),
    h(),
